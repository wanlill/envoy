...
private:
  ...
  public:
    ConnectionCallbacksWrapper(MagicTlsConnectionImpl& parent, ClientConnection& connection)
  ...
  private:
    MagicTlsConnectionImpl& parent_;
  ...
  // Addresse to attempt to connect to.
  Address::InstanceConstSharedPtr address_;
  // Connection count.
  size_t next_connection_ = 0;
